...
from .. import _Polynomial, _Scalar
...
class NonCommutativeOperator:
    ...
    @overload
    def __add__(self, other: _NonCommutativePolynomialElement) -> RealCoefficientsNonCommutativePolynomial: ...
    @overload
    def __add__(
        self, other: _Polynomial[_NonCommutativePolynomialElement, _Scalar]
    ) -> _Polynomial[_NonCommutativePolynomialElement, _Scalar]: ...
    @overload
    ...
    @overload
    def __sub__(self, other: _NonCommutativePolynomialElement) -> RealCoefficientsNonCommutativePolynomial: ...
    @overload
    def __sub__(
        self, other: _Polynomial[_NonCommutativePolynomialElement, _Scalar]
    ) -> _Polynomial[_NonCommutativePolynomialElement, _Scalar]: ...
    ...
    @overload
    def __mul__(self, other: _NonCommutativePolynomialElement) -> NonCommutativeMonomial: ...
    @overload
    def __mul__(
        self, other: _Polynomial[_NonCommutativePolynomialElement, _Scalar]
    ) -> _Polynomial[_NonCommutativePolynomialElement, _Scalar]: ...
...
_NonCommutativePolynomialElement: TypeAlias = NonCommutativeMonomial | NonCommutativeOperator

class _NonCommutativePolynomial(_Polynomial[_NonCommutativePolynomialElement, _Scalar]):
    def adjoint(self) -> Self: ...

RealCoefficientsNonCommutativePolynomial: TypeAlias = _NonCommutativePolynomial[float]
ComplexCoefficientsNonCommutativePolynomial: TypeAlias = _NonCommutativePolynomial[complex]
