...
class CommutativeOperator:
    ...
    @overload
    def __add__(self, other: _CommutativePolynomialElement) -> RealCoefficientsCommutativePolynomial: ...
    @overload
    def __add__(
        self, other: _Polynomial[_CommutativePolynomialElement, _Scalar]
    ) -> _Polynomial[_CommutativePolynomialElement, _Scalar]: ...
    @overload
    ...
    @overload
    def __sub__(self, other: _CommutativePolynomialElement) -> RealCoefficientsCommutativePolynomial: ...
    @overload
    def __sub__(
        self, other: _Polynomial[_CommutativePolynomialElement, _Scalar]
    ) -> _Polynomial[_CommutativePolynomialElement, _Scalar]: ...
    ...
    @overload
    def __mul__(self, other: _CommutativePolynomialElement) -> CommutativeMonomial: ...
    @overload
    def __mul__(
        self, other: _Polynomial[_CommutativePolynomialElement, _Scalar]
    ) -> _Polynomial[_CommutativePolynomialElement, _Scalar]: ...
...
_CommutativePolynomialElement: TypeAlias = CommutativeMonomial | CommutativeOperator

class _CommutativePolynomial(_Polynomial[_CommutativePolynomialElement, _Scalar]):
    def conjugate(self) -> Self: ...

RealCoefficientsCommutativePolynomial: TypeAlias = _CommutativePolynomial[float]
ComplexCoefficientsCommutativePolynomial: TypeAlias = _CommutativePolynomial[complex]
